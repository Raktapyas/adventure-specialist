<x-app-layout>
    <x-slot name="header">
        <h1 class="text-xl font-semibold text-gray-950">Edit Page</h1>
    </x-slot>
        ...
        <form method="POST" action="{{ route('admin.pages.update', $page) }}" class="bg-white rounded-lg shadow-sm p-6 space-y-6">
            ...
            <div>
                <label class="flex items-center gap-2 text-sm text-gray-700">
                    <input type="checkbox" name="is_published" value="1" @checked(old('is_published', $page->is_published)) class="rounded border-gray-300 text-amber-600 focus:ring-amber-500">
                    Published
                </label>
