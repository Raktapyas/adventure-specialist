<x-app-layout>
    <x-slot name="header">
        <h1 class="text-xl font-semibold text-gray-950">Add Service</h1>
    </x-slot>

    <div class="max-w-3xl">
        <form method="POST" action="{{ route('admin.services.store') }}" class="bg-white rounded-lg shadow-sm p-6 space-y-6">
            @csrf
