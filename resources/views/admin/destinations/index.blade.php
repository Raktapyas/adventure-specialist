<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4 mb-6">
            <h2 class="text-xl font-semibold text-gray-950">Destinations</h2>
            <a href="{{ route('admin.destinations.create') }}" class="inline-flex items-center px-4 py-2 rounded-lg bg-amber-600 text-white text-sm font-medium hover:bg-amber-500">
                Add Destination
            </a>
        </div>
    </x-slot>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-5 py-6 text-center text-gray-500">No destinations yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
