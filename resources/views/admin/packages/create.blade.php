<x-app-layout>
    <x-slot name="header">
        <h1 class="text-xl font-semibold text-gray-950">Add Package</h1>
    </x-slot>

    <div class="max-w-3xl">
        <form method="POST" action="{{ route('admin.packages.store') }}" class="bg-white rounded-lg shadow-sm p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <x-text-input id="duration_days" name="duration_days" type="number" class="mt-1 w-full" value="{{ old('duration_days') }}" />
